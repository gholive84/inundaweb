        ...
        <div class="contact__inner">
            ...
            <form class="contact-form" id="contactForm" novalidate>
                <div class="contact-form__fields">
                    ...
                    <div class="form-group">
                        <label for="cf_phone">Telefone / WhatsApp</label>
            ...
            <div class="contact__info">
                ...
                <div class="contact-info-item">
                    <div class="contact-info-item__icon">
                        <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.36 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.28 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                    </div>
                    <div>
                        <h4>Telefone</h4>
                        <a href="tel:+554132222857">(41) 3222-2857</a>
                    </div>
                </div>
                <div class="contact-info-item">
                    <div class="contact-info-item__icon">
                    ...
                    <div>
                        <h4>Endereço</h4>
                        <p>Av. Sete de Setembro, 3038, Lj 02<br>Curitiba / PR</p>
                    </div>
                </div>
                <div class="contact-info-item">
                    <div class="contact-info-item__icon">
